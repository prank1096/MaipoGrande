			...
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(images/about.jpg);">
						<a href="https://www.youtube.com/watch?v=85_NrLBtaOc" class="icon popup-vimeo d-flex justify-content-center align-items-center">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Bienvenidos a MaipoGrande SitioWeb de Compras y Ventas de Frutas & verduras</h2>
	            </div>
	          </div>
	          <div class="pb-md-5">
	          	<p>La empresa “Maipo Grande”, agrupa empresas dedicadas a la producción de frutas en la zona metropolitana 
                ...
                mercado extranjero y local.
							...
							<p>En base a toda la organizacion a traves de Cliente, Productor, Ventas locales, Transportistas y los administradores, es una empresa corporativa con bastantes conexiones
                para poder el facilitar la venta a nuestros clientes tanto locales como extranjero ademas de dando un uso amigable para la compras diarias.</p>
							<p><a href="index.php" class="btn btn-primary">MaipoGrande</a></p>
						</div>
					</div>
				</div>
			</div>
